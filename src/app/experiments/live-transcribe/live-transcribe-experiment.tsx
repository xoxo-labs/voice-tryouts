    ...
    <div className="flex flex-col gap-6">
      ...
      <div className="grid gap-6 lg:grid-cols-[300px_minmax(0,1fr)] xl:grid-cols-[340px_minmax(0,1fr)]">
        ...
        <Tabs defaultValue="live" className="min-w-0">
          ...
          <TabsContent value="live" className="mt-4">
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Streaming deltas are grey and italic. An utterance is
                  finalised only when a commit is sent — this model has no
                  server-side turn detection, so the app commits after{" "}
                  <span className="font-mono text-xs">1.5 s</span> of delta
                  silence.
                </CardDescription>
              </CardHeader>
              <CardContent>
          ...
          <TabsContent value="benchmark" className="mt-4 flex flex-col gap-6">
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  ...
                  relative to the{" "}
                  <code className="font-mono text-xs">start()</code> call.
                </CardDescription>
              </CardHeader>
              <CardContent>
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Connection setup is the noisiest number — judge it over
                  several runs.
                </CardDescription>
              </CardHeader>
              <CardContent>
          ...
          <TabsContent value="diagnostics" className="mt-4 flex flex-col gap-6">
            <Card>
              <CardHeader>
                <CardTitle>Connection test</CardTitle>
                <CardDescription>
                  Checks every link in the chain and says exactly which one
                  broke. A check that cannot run reports why it was skipped.
                </CardDescription>
              </CardHeader>
              <CardContent>
                <ConnectionTestPanel
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Read from{" "}
                  <code className="font-mono text-xs">pc.getStats()</code>. If
                  these stay at zero while connected, the microphone is the
                  problem, not the API.
                </CardDescription>
              </CardHeader>
              <CardContent>
